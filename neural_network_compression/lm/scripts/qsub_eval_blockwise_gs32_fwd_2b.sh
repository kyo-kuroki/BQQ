...
# Assemble and evaluate PPL for blockwise-forward gs32 30000step 2B models (2-bit and 3-bit).
...
echo "========================================"
echo "Blockwise-Forward BQQ PPL Evaluation - 2B gs32 30000step"
echo "Host: $(hostname)"
...
for BIT in 2 3; do
    BLOCK_DIR="${LM_DIR}/blockwise_output/Qwen3.5-2B-${BIT}bit-gs32-30000step-c4"
    ASSEMBLED_PATH="${OUTPUT_DIR}/Qwen3.5-2B-${BIT}bit-32gs-blockwise-fwd.pth"

    echo ""
    echo "========================================"
    echo "Processing ${BIT}-bit blockwise-fwd gs32 model"
    echo "========================================"
    ...
    echo "Done: ${BIT}-bit gs32-fwd  $(date --iso-8601=seconds)"
done
