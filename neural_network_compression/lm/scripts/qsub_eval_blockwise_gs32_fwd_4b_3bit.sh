...
# Assemble and evaluate PPL for blockwise-forward gs32 30000step 4B 3-bit model.
...
BLOCK_DIR="${LM_DIR}/blockwise_output/Qwen3.5-4B-${BIT}bit-gs32-30000step-c4"
ASSEMBLED_PATH="${OUTPUT_DIR}/Qwen3.5-4B-${BIT}bit-32gs-blockwise-fwd.pth"
mkdir -p "${OUTPUT_DIR}"

echo "========================================"
echo "Blockwise-Forward BQQ PPL Evaluation - 4B gs32 30000step ${BIT}bit"
echo "Host: $(hostname)"
...
echo "Done: 4B ${BIT}-bit gs32-fwd  $(date --iso-8601=seconds)"
