...
# Layer-wise BQQ quantization job.
# Quantizes all linear weights of a model sequentially in one GPU run.
# Supports resumption: individual tensor .pth files are skipped if already present.
#
...
echo "========================================"
echo "Layer-wise BQQ Quantization"
...
echo ""
echo "Done: ${MODEL_NAME} ${BIT_WIDTH}bit  $(date --iso-8601=seconds)"
