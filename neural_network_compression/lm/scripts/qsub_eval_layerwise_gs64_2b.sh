...
# Build and evaluate PPL for layerwise gs64 30000step 2B models (2-bit and 3-bit).
...
echo "========================================"
echo "Layerwise BQQ PPL Evaluation - 2B gs64 30000step"
echo "Host: $(hostname)"
...
for BIT in 2 3; do
    DATA_DIR="${LM_DIR}/layerwise_output/Qwen3.5-2B-${BIT}bit-gs64-30000step-c4"
    ASSEMBLED_PATH="${OUTPUT_DIR}/Qwen3.5-2B-${BIT}bit-64gs.pth"
